...
public class RandomGeneratorTutorial {
    public static void main(String[] args) throws Exception {
        ...
        Graph<String, Integer> g2 = RandGenerator.generateKleinbergSWGraph(
                factory, factory.vertexFactory, factory.edgeFactory, 5, 5, 1, 2, 2);
        Visualization.showGraph(g2);

        Graph<String, Integer> g3 = RandGenerator.generateWattsStrogatzSWGraph(
        ...
        Graph<String, Integer> g5 = RandGenerator.generateBarabasiAlbertGraph(
                factory, factory.vertexFactory, factory.edgeFactory, 10, 5, 7);
        Visualization.showGraph(g5);

        Graph<String, Integer> g6 = RandGenerator.generateEppsteinGraph(
                factory, factory.vertexFactory, factory.edgeFactory, 10, 25, 100);
        Visualization.showGraph(g6);

        Graph<String, Integer> g7 = RandGenerator.generateRandomRegularGraph(
