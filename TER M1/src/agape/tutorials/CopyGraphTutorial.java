...
public class CopyGraphTutorial {
	...
	public static void main(String[] args) {
		...
		/*
		 * This is an explicit call to the copyUndirectedSparseGraph method (we know
		 * that the graph is undirected)
		 */
		System.out.println(gu);
		UndirectedSparseGraph<String, Integer> gu2 = (UndirectedSparseGraph<String, Integer>) Operations
				.copyUndirectedSparseGraph(gu);
		System.out.println(gu2);
		/*
		 * This is a general call to the copyGraph method that uses a factory (we do not
		 * want to know if the graph is direted or not)
		 */
		UndirectedSparseGraph<String, Integer> gu3 = (UndirectedSparseGraph<String, Integer>) Operations.copyGraph(gu,
				undfactory);
