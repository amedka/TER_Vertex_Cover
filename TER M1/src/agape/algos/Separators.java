...
public class Separators<V, E> extends Algorithms<V, E> {
	...
	/**
	 * Returns the set of minimal ab-separator between vertices a and b in O(n^3)
	 * per separator. The implementation is based on an algorithm of Berry, Bordat,
	 * Cogis in ("Generating All the Minimal Separators of a Graph", 2000).
	 *
	 * @param g graph
	 * @param a vertex a
	 * @param b vertex b
