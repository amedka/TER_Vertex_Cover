...
public class MVCCompareAlgorithms {
	public static void main(String[] args) {
		...
		// Graph<String, Integer> gu = generator.generateErdosRenyiGraph(factory,
		 ...
		 *
		 * System.out.println("result BruteForce ErdosRenyi k=4: " +
		 * mvc.getVertexCoverSolution());
		 *
		 *
		 ...
		 * System.out.println("result BruteForce petersen k=3: " +
		 * mvc.getVertexCoverSolution());
		 */
	}
}