...
public class AgapeCL {
  ...
  static final int SEP=110;
    ...
    public static double launchAlgorithm(Graph<String,Integer> G, int algo, boolean directed)
    {
        ...
        switch(algo)
        {
            case MISBF:
                ...
                S=((MIS)alg).maximumIndependentSetBruteForce(G);
            ...
            case MISMM:
                alg=new MIS(graphFactory,vertexFactory, edgeFactory);
                t=System.currentTimeMillis();
                S=((MIS)alg).maximumIndependentSetMoonMoser(G);
                t=System.currentTimeMillis()-t;
                break;
            ...
            case MISDegMax:
                alg=new MIS(graphFactory,vertexFactory, edgeFactory);
                t=System.currentTimeMillis();
                S=((MIS)alg).maximumIndependentSetMaximumDegree(G);
                t=System.currentTimeMillis()-t;
                break;
            ...
            case MISFGK:
                alg=new MIS(graphFactory,vertexFactory, edgeFactory);
                t=System.currentTimeMillis();
                S=((MIS)alg).maximuRmIndependentSetFominGrandoniKratsch(G);
                t=System.currentTimeMillis()-t;
                break;
            ...
            case MVCBF:
                ...
                S=((MVC)alg).getVertexCoverSolution();
                t=System.currentTimeMillis()-t;
                break;
            ...
            case MVCN:
             ...
             case DFVS:
                ...
                t=System.currentTimeMillis();
                S=((MinDFVS)alg).maximumDirectedAcyclicSubset(Gp);
                t=System.currentTimeMillis()-t;
             ...
             case CN:
                 ...
                 t=System.currentTimeMillis();
                 S=((Coloring)alg).graphColoring(G);
                 t=System.currentTimeMillis()-t;
                 break;
             ...
             case SEP:
                 alg=new Separators();
                 t=System.currentTimeMillis();
                 S=((Separators)alg).getAllMinimalSeparators(G);
                 t=System.currentTimeMillis()-t;
                 break;
        }
    ...
    /*
     * Use: arguments: graphfilepath|graphdirectorypath algorithm [D] (for directed graph)
     */
    ...
    public static void main(String[] args) {
        ...
        int algo=0;
        if( args[1].equals("CN")) algo=CN;
        if( args[1].equals("SEP")) algo=SEP;
        if( args[1].equals("MISBF")) algo=MISBF;
        if( args[1].equals("MISMM")) algo=MISMM;
        if( args[1].equals("MISDegMax")) algo=MISDegMax;
        if( args[1].equals("MISFGK")) algo=MISFGK;
        if( args[1].equals("MVCBF")) algo=MVCBF;
        if( args[1].equals("MVCBG")) algo=MVCBG;
        if( args[1].equals("MVCDBS")) algo=MVCDBS;
        if( args[1].equals("MVCN")) algo=MVCN;
        if( args[1].equals("DFVS")) algo=DFVS;
        ...
        {
            ArrayList<File> graphs=listFiles(folder);
            for(File f : graphs)
            {
    ...
    public static void Bench(Graph<String, Integer> G, int algo)
    {
             ...
             if(algo==DFVS)
                t=launchAlgorithm(G,algo,true);
             else
                t=launchAlgorithm(G,algo,false);
