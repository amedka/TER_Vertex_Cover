...
public class NRandomGeneratorTutorial {
	public static void main(String[] args) {
		...
		Graph<String, Integer> g = NRandGenerator.generateRegularRing(factory, factory.vertexFactory, factory.edgeFactory, 20, 6);
		Visualization.showGraph(g, new CircleLayout<String,Integer>(g));
		
		Graph<String, Integer> g2 = NRandGenerator.generateGridGraph(factory, factory.vertexFactory, factory.edgeFactory, 3, 5, false);
