...
public class Import {
    ...
    /**
     * Returns an undirected graph by reading a .trg file 
     * TRG means Trace Graphe
     * It is the format exported by System.out.println(g);
     * For example:
     * Vertices:v53,v50,v58
     * Edges:254[v58,v53] 255[v50,v58] 
     * @param fname file path
     * @return graph
     */
